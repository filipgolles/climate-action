const food = [
  ...
  'stir fry recipe',
  'give me the recipe for spaghetti bolognese with cheese',
  'how to cook chicken and ketchup'
];
...
const register = [
  ...
  'i ate tofu instead of ham',
  'didn\'t take the car to work today'
];
...
module.exports = { food, present, register, weather, reset };
